...
Имея оценку результата реализации предложения (то есть имея результаты второго голосования) и зная исходные голоса мастернод, мы можем оценить эффективность первого голосования. Стоит отметить, что мы хотим оценить именно исходный голос мастерноды, поскольку во время первого голосования нужно проделать самую сложную работу по изучению предложения.
